<header class="site">
    <div class="wrap">
        <a href="{{ route('site.home') }}" class="logo">
            <img src="{{ site_setting_image_url('logo') }}" alt="" class="logo-mark">
            IPCash
        </a>
        <nav class="main">
        ...
        <div class="header-actions">
            <div class="download-dropdown">
                ...
                <div class="download-menu" id="downloadMenu" hidden>
                    <a href="{{ site_setting('store_app_store') ?: route('site.home').'#telecharger' }}" aria-label="App Store">
                    ...
                    <a href="{{ site_setting('store_google_play') ?: route('site.home').'#telecharger' }}" aria-label="Google Play">
