<x-site-layout :title="'Sécurité'" :description="'Comment IPCash protège votre argent et vos données : vérification d’identité, code PIN et biométrie, chiffrement, contrôle des sessions et blocage immédiat.'">
    ...
    <section class="tight">
        <div class="wrap">
            <div class="timeline">
                <div class="timeline-item reveal" id="acces">
                    <div class="timeline-marker" style="background:var(--green);">{!! $iconSvg('lock') !!}</div>
                ...
                <div class="timeline-item reveal" id="identite">
                    <div class="timeline-marker" style="background:var(--hero-end);">{!! $iconSvg('idcard') !!}</div>
                    <div class="timeline-content">
                ...
                <div class="timeline-item reveal" id="sessions">
                    <div class="timeline-marker" style="background:var(--sun);">{!! $iconSvg('wifi') !!}</div>
                    <div class="timeline-content">
                ...
                <div class="timeline-item reveal" id="blocage">
                    <div class="timeline-marker" style="background:var(--pink);">{!! $iconSvg('block') !!}</div>
                    <div class="timeline-content">
